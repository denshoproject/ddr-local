...
COLLECTION_STATUS_TIMEOUT = 60*60*1  # 1 hour
COLLECTION_ANNEX_STATUS_TIMEOUT = 60*60*24*7  # 7 days
COLLECTION_ANNEX_WHEREIS_TIMEOUT = 60*60*24*7
COLLECTION_ANNEX_MAP_TIMEOUT = 60*60*24*7
