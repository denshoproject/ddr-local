...
WEBUI_MESSAGES = {
    ...
    'VIEWS_COLL_ERR_NO_IDS': 'Error: Could not get new collection ID from ID service (%s error).',
    ...
    'VIEWS_ENT_ERR_NO_IDS': 'Error: Could not get new object ID from ID service (%s error).',
