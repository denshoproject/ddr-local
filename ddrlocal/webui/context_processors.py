...
def sitewide(request):
    ...
    return {
        ...
        'MODERNIZR': settings.STATICFILE_VERSIONS['MODERNIZR'],
        'JQUERY': settings.STATICFILE_VERSIONS['JQUERY'],
        'BOOTSTRAP': settings.STATICFILE_VERSIONS['BOOTSTRAP'],
        'TAGMANAGER': settings.STATICFILE_VERSIONS['TAGMANAGER'],
        'TYPEAHEAD': settings.STATICFILE_VERSIONS['TYPEAHEAD'],
